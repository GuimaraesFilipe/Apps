import { __decorate, __metadata, __spread, __extends } from 'tslib';
import { ɵɵdefineInjectable, Injectable, EventEmitter, ViewChild, ElementRef, Input, Output, Component, HostBinding, HostListener, NgModule } from '@angular/core';
import { animation, style, animate, trigger, transition, query, stagger, useAnimation } from '@angular/animations';
...
var ChatViewService = /** @class */ (function () {
    ...
    ChatViewService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ChatViewService_Factory() { return new ChatViewService(); }, token: ChatViewService, providedIn: "root" });
...
var messagePushAnimation = animation([
    style({
        opacity: '{{ opacity }}',
...
/*
 * Public API Surface of chat-view
 */
...
export { ChatViewComponent, ChatViewModule, ChatViewService, MESSAGE_CATEGORY, MESSAGE_TYPES, Message, ReceivedMessage, SentMessage, messagePushAnimation as ɵa, ReceivedMessageComponent as ɵb, SentMessageComponent as ɵc, MessageComponent as ɵd, UserInputComponent as ɵe, ChatHeaderComponent as ɵf, SendSVGImage as ɵg };
